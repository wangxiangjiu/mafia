...
var newSessionHandlers = {
    'NewSession': function () {
        ...
        this.emit(':ask', 'Werewolf game here. The game requires 6 players. Two werewolves, a doctor, a sear, and two villegers. To join the game, please enter the url. Please enter the room in on the webpage. The room number is' + room_number);
    },
...
var mainHandlers = Alexa.CreateStateHandler(states.MAINMODE, {
    ...
    'MainIntent': function () {
        ...
        if (user_res === "ready" && num_people === 6) {
            ...
            this.emit(':ask', 'sorry, room not filled yet. Please make sure everyone has entered the room.');
        }
    },
    'FoodIntent': function () {
